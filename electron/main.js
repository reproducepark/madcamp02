...
4. **업무 취합:**
   - **"어제까지 한 일"**: \`team_goals\` 내의 각 목표(goal)의 \`subgoals\` 중 \`is_completed\` 필드가 **true**인 모든 작업을 취합하여 목록으로 작성합니다. 완료된 작업의 \`real_end_date\`가 현재 날짜(2025-07-16)보다 이전이거나 같은 경우에만 포함합니다.
